        ...
        <div className="w-full max-w-5xl mb-4">
          ...
          <div className="flex flex-col md:flex-row mb-4 layout-container">
            ...
            >
              ...
              {/* GitHub stats - properly positioned below the content */}
              {
                /* <div className="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-3 mt-3 justify-center items-center">
                <Image
                  src="https://github-readme-stats.vercel.app/api?username=manavvgarg&show_icons=false&theme=swift&include_all_commits=true"
                  alt="GitHub Stats"
                  width={380}
                  height={150}
                  className="border border-black dark:border-white w-full max-w-[380px]"
                />
                <Image
                  src="https://github-readme-stats.vercel.app/api/top-langs/?username=ManavvGarg&hide=lua&theme=swift&layout=donut"
                  alt="Most Used Languages"
                  width={270}
                  height={150}
                  className="border border-black dark:border-white w-full max-w-[270px]"
                />
              </div> */
              }
